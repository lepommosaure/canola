...
if {$tb_name == "main_tb_tmr_wrap_no_tmr" || $tb_name == "all_tb"} {
    vsim $coverage_option $debug_db_option -gui -t ps  -gG_TMR_TOP_MODULE_EN=true -gG_SEE_MITIGATION_EN=0 work.canola_top_tb
    do 00-wave_can_ctrl.do
    run -all
    if {$sim_coverage == "true"} {
...
if {$tb_name == "main_tb_tmr_wrap_tmr" || $tb_name == "all_tb"} {
    vsim $coverage_option $debug_db_option -gui -t ps  -gG_TMR_TOP_MODULE_EN=true -gG_SEE_MITIGATION_EN=1 work.canola_top_tb
    do 00-wave_can_ctrl.do
    run -all
    if {$sim_coverage == "true"} {
...
if {$tb_name == "axi_tb_tmr_wrap_no_tmr" || $tb_name == "all_tb"} {
    vsim $coverage_option $debug_db_option -gui -t ps  -gG_TMR_TOP_MODULE_EN=true -gG_SEE_MITIGATION_EN=0 work.canola_axi_slave_tb
    do 00-wave_can_ctrl.do
    run -all
    if {$sim_coverage == "true"} {
...
if {$tb_name == "axi_tb_tmr_wrap_tmr" || $tb_name == "all_tb"} {
    vsim $coverage_option $debug_db_option -gui -t ps  -gG_TMR_TOP_MODULE_EN=true -gG_SEE_MITIGATION_EN=1 work.canola_axi_slave_tb
    do 00-wave_can_ctrl.do
    run -all
    if {$sim_coverage == "true"} {
